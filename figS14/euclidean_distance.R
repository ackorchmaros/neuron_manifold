...
distance.matrix.low<-parDist(matrix.stim.repeat, method = "euclidean") # The lower triangle of the distance matrix stored by columns in a vector
distance.matrix<-vec2symMat(distance.matrix.low, diag = 0, byrow = FALSE)
#(3)
if (type.data =='NULL'){
