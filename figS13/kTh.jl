######################################################### NPCA dimension estimate with tight threshold wrt to the number of nearest neighbours WRAPPER
...
cd(input_folder)
include("k_cluster_th_savefig.jl")

# compute dimension diagram
output  =  parsed_args["fout"]
println("Computing dimension estimate ..") 
DimensionDiagramsNPCAnn(matrix_data, matrix_NN,2,output)
