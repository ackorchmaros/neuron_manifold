...
% permute rows/stimuli using different permutations across repeats and different permutations for each column/neuron
% only 1 mouse 
function cvPCA_eigs_mice_shuffle(dataroot, matroot,mouse_tag,mouse)
...
for k = 1:20 % number of permutations
    ...
    % choose different seeds per repeat, permutation and mouse
...
save(fullfile(matroot,sprintf('eigs_%s_shuffle.mat',mouse_tag)), 'specSpi')
