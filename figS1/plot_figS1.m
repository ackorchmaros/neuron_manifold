function plot_figS1(matroot,myplotroot,sample_case,normal,uniform_cluster1,uniform_cluster2,dimension,sample_size)
close;
...
legend boxoff;
axis tight;
print(fullfile(myplotroot,'figS1.pdf'),'-dpdf');
