#--------------------------------------Sampling from orthogonal group in 10k-dim space with multivariate Gaussian distribution
...
#(4)
f.sample.og<-paste0(out.dir,"/",ambient.dimension,'ambient_',sample.size,"sample_",og.dimension,"og_normalSample.mat")
